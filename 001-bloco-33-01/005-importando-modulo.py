...
# Uma outra maneira de utilizarmos o import é utilizando from area import rectangle , 
# porém, tome cuidado com conflitos de nomes caso utilize a segunda maneira.